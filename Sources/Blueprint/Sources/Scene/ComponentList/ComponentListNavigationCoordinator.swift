...
final class ComponentListNavigationCoordinator: ObservableObject {
    ...
    func destinationView(for componentType: Component) -> some View {
        ...
        case .filterButton: FilterButtonPreview()
        ...
        case .horizontalProgressTracker: HorizontalProgressTrackerPreview()
        case .verticalProgressTracker: VerticalProgressTrackerPreview()
        case .dateTimePicker: DateTimePickerPreview()
        case .paginationDots: PaginationDotsPreview()
        case .pageCounter: PageCounterPreview()
        ...
        case .bottomSheet: BottomSheetPreview()

...
/// ``Montage/RoundCheckboxUIView``의 터치 이벤트를 받을 수 있는 Delegate입니다.
protocol RoundCheckboxControlDelegate: AnyObject {
    /// 터치가 발생하였을 때 호출되는 메소드입니다.
    /// - Parameter checkbox: 터치가 발생한 객체
    func didTappedCheckbox(_ checkbox: Control.RoundCheckboxUIView)
}
...
extension Control {
    ...
    public final class RoundCheckboxUIView: UIView, MontageControl {
        ...
        weak var delegate: RoundCheckboxControlDelegate?
...
extension Control.RoundCheckboxUIView {
...
extension Control.RoundCheckboxUIView: UIGestureRecognizerDelegate {

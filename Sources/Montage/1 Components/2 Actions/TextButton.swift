...
public struct TextButton: View {
    ...
    public init(
        ...
        let mappedColor: Button.Color = {
            switch color {
            case .primary: .primary
            case .assistive: .assistive
            }
        }()
        let mappedSize: Button.Size = {
            switch size {
            case .small: .small
            case .medium: .medium
            }
    ...
    public func contentColor(_ contentColor: SwiftUI.Color?) -> Self {
        .init(base: base.contentColor(contentColor))
    }
    ...
    public func fontVariant(_ fontVariant: Typography.Variant?) -> Self {
        .init(base: base.fontVariant(fontVariant))
    }
    ...
    public func fontWeight(_ fontWeight: Typography.Weight?) -> Self {
        .init(base: base.fontWeight(fontWeight))
    }

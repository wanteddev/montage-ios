...
``func bottomContent((() -> any View)?) -> ListCard``
...
``func leadingContent((() -> any View)?) -> ListCard``
...
``func topContent((() -> any View)?) -> ListCard``
...
``func trailingContent((() -> any View)?) -> ListCard``
...
[View Implementations](/documentation/montage/listcard/view-implementations.md)
